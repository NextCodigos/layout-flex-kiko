...
// console.log(variable)//undefined esta antes de ser declarada la variable error fuera scope
...
// const para variables que no se pueden modificar ejemplo nº pi

// Definimos scope de bloque:
{
    const PI = 3.14;
    console.log(PI);
}
console.log(PI);//ERORR pi solo existe dentro del bloque